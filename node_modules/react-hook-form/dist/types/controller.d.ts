...
import { Control, DeepMapImpl, DeepPartial, FieldError, FieldPath, FieldPathValue, FieldValues, RefCallBack, UnionLike, UnpackNestedValue, UseFormStateReturn } from './';
declare type ControllerFieldError<T> = DeepMapImpl<DeepPartial<UnionLike<T>>, FieldError>;
